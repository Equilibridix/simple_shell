 ...
 * @command: command given as input
 ...
 * @val: val of the environmental variable
 ...
 * @val: val to replace matched keys
...
/* shell.c */
int more_cmds(buffer *buf, int return_val);
...
env_t *add_env(env_t **head, char *val);
...
char *rm_vname(env_t *envp, char *arg, int bufsize);
...
void buff_word_erase(buffer *b, int num);
void buff_insert(buffer *b, char *s, int num);
...
int hsh_setenv(char **arg, env_t *env_p, int bufsize);
int hsh_unsetenv(char **arg, env_t *env_p);
int hsh_cd(char **arg, env_t *env_p, int bufsize);
int hsh_help(char **arg);
int hsh_exit(char **arg_list, env_t *env_p, int bufsize);
int hsh_history(char **arg, env_t *env_p, int bufsize);
